# CHANGELOG archive — §1 through §40 (2026-08-07 to 2026-08-27)

**This is the first half of `CHANGELOG.md`, moved here unchanged.** Sections are
verbatim, in their original order, with their original §-numbering preserved as
historical record (not renumbered). Nothing was rewritten, summarized, or
dropped in the move.

**Why it was split:** the combined file had grown past 7,500 lines, so opening it
for orientation cost more than the closed, historical majority of it justified —
the same reasoning that originally split `CHANGELOG.md` out of `AUDIT_REPORT.md`
(see the archival note reproduced below). The cut falls on a clean date
boundary: everything here is 2026-08-27 or earlier; §41 onward, which is the
current September work, stays in `CHANGELOG.md`.

**Cross-references still work.** Other documents cite these sections as `§N`, and
that numbering is unchanged — a citation to, say, `CHANGELOG.md §30` now resolves
to §30 in this file. `CHANGELOG.md` carries a pointer to that effect.
