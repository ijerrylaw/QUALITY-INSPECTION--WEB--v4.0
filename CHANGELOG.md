...
`AUDIT_REPORT.md` in the course of a real work session; §1-§17 were moved
here verbatim, unedited, in their original chronological order and with
their original §-numbering preserved as historical record (not renumbered).
...
**Archival note (2026-08-10):** this file was split out of a single
...
small number of genuinely open items justified. Nothing below was rewritten
or summarized in the split — this is the original content, relocated.
